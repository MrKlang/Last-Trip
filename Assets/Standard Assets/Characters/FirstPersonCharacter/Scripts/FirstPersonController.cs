...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            m_MoveDir.z = 2*desiredMove.z*speed;
            ...
            if (isSliding)
            {
                ...
                {
                    isSliding = false;
                    m_CharacterController.height = 1.8f; // crouch/stand up smoothly
                }
            }
        ...
        IEnumerator SmoothH(float variable)
        {
            ...
            while (t < 0.5f)
            {
                ...
                Vector3 posend = new Vector3(pos.x, pos.y, pos.z);
        ...
        /*private void RotateView() Blokada rotacji
        {
